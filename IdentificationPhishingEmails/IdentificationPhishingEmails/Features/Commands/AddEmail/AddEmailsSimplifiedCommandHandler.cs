...
{
    public class AddEmailsSimplifiedCommandHandler : IRequestHandler<AddEmailsSimplifiedCommand, List<EmailSimplified>>
    {
        private readonly DataContext _dataContext;

        public AddEmailsSimplifiedCommandHandler(DataContext dataContext)
        {
            _dataContext = dataContext;
        }

        public async Task<List<EmailSimplified>> Handle(AddEmailsSimplifiedCommand request, CancellationToken cancellationToken)
        {
            ...
            var newEmailsSimplified = newEmails.Select(email =>
                new EmailSimplified
                {
                    Id = email.Id,
                    Sender = email.Sender,
